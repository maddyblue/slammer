...
adddir("programs/help/images", $file);
adddir("programs/help/science", $file);
adddir("programs/help/help", $file);
adddir("programs/help/program", $file);
adddir("programs/help/terms", $file);
